...
useEffect(() => {
  ...
  return (
<div className="w-full sm:max-w-screen-md sm:mx-auto bg-white shadow rounded-lg p-4 sm:p-6 sm:my-6 overflow-x-hidden">
...
<header className="bg-white shadow w-full px-4 sm:px-6 py-4 flex justify-between items-center">
        ...
        {/* Tab Content */}
<main className="flex-1 overflow-y-auto px-4 sm:px-6 md:px-8 w-full mt-6">
